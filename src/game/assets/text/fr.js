...
const NPC_FRIEND = {
hole: "Salut "+ PLAYER_NAME + ", regarde ce trou dans la glace. C'est le genre de chose qui peut te piéger si tu n'y fais pas attention.\nAvec la fonte des glaces de plus en plus rapide ces jours-ci, il y en a de plus en plus.\nVeille à ne pas tomber dedans !",
